...
class TCtoPsi4:
    ...
    def __init__(self, basis, coordinates):
        """
        coordinates denotes the coordinate system one wants to carry out the Psi4 calculation in.
        (Cartesian for puream=False, Spherical for puream=True)
        basis denotes the basis set used for both the TeraChem and Psi4 calculations.
        """
